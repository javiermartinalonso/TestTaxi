...
/**
	 ...
	 * @see com.testtaxi.hibernate.Usuarios
  * 
 */
public class UsuariosDAO extends HibernateDaoSupport  {
    ...
    public Usuarios findById( java.lang.String id) {
        ...
        try {
            Usuarios instance = (Usuarios) getHibernateTemplate()
                    .get("com.testtaxi.hibernate.Usuarios", id);
            return instance;
        } catch (RuntimeException re) {
	...
	public List findByApellido1(Object apellido1
	) {
		return findByProperty(APELLIDO1, apellido1
		);
	}
	
	public List findByApellido2(Object apellido2
	) {
